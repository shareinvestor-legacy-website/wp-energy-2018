...
<form class="form form--primary" action="{{action('Web\MailController@siteVisit', ['name'=>'site-visit'])}}" method="post">
    ...
    <div class="form-row">
        <div class="form-group col-sm-6">
            ...
            <input class="form-control" id="fullname" name="fullname" type="text" value="{{old('fullname')}}" required/>
        ...
        <div class="form-group col-sm-6">
            ...
            <input class="form-control" id="telephone-1" name="telephone1" type="text" value="{{old('telephone1')}}" placeholder="Ex. 080-1234567" required/>
        ...
        <div class="form-group col-sm-6">
            ...
            <input class="form-control" id="telephone-2" name="telephone2" type="text" value="{{old('telephone2')}}" placeholder="Ex. 080-1234567"/>
