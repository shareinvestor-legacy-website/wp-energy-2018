...
<div class="stock">
    <div class="stock__date">
        <h3>{{t('stock.price')}}</h3>
        <p class="stock--datetime">{{t('last.updated')}} <time class="d-inline-block">{{$stock->present()->datetime('dd MMM yyyy H:i A')}}</time></p>
    </div>
    ...
    <div class="stock__value">
        <p>
            ...
            <span class="stock__text stock__text--semibold">{{$stock->present()->last_done}}</span>
        </p>
    </div>
