            ...
            <div class="banner">
                <div class="banner__slide">
                    <div class="owl-carousel owl-theme">
                        <div class="item" style="background-image: url(/themes/default/assets/static/images/home/banner-01.jpg)"></div>
                        <div class="item" style="background-image: url(/themes/default/assets/static/images/home/banner-02.jpg)"></div>
                        <div class="item" style="background-image: url(/themes/default/assets/static/images/home/banner-03.jpg)"></div>
                    </div>
                </div>
                ...
                <div class="banner__container">
                    <div class="banner__title">
                        <div class="container">
                            <div class="banner--image">
                                <img src="/themes/default/assets/static/images/home/svg/power-title.svg" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="banner__icon">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <div class="list-group list-group--icon">
                                        <a class="list-group-item active" href="/what-we-do/product-and-services/lpg-for-life.html">
                                            <i class="icon-fire"></i>
                                            <div class="banner__text">LPG For Life</div>
                                        </a>
                                        <a class="list-group-item" href="/what-we-do/product-and-services/automobile.html">
                                            <i class="icon-oil"></i>
                                            <div class="banner__text">Automobile</div>
                                        </a>
                                        <a class="list-group-item" href="/what-we-do/product-and-services/hosehold.html">
                                            <i class="icon-gas"></i>
                                            <div class="banner__text">Hosehold</div>
                                        </a>
                                        <a class="list-group-item" href="/what-we-do/product-and-services/industry.html">
                                            <i class="icon-factory"></i>
                                            <div class="banner__text">Industry</div>
                                        </a>
                                        <a class="list-group-item" href="/what-we-do/product-and-services/services.html">
                                            <i class="icon-tools"></i>
                                            <div class="banner__text">Services</div>
                                        </a>
                                    </div>
                                </div>
                            </div>
