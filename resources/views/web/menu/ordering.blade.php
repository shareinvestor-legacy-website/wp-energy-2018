...
@section('content')
    ...
    <div class="content-heading">
        ...
        @include('component.breadcrumb', ['items' => ['Web', 'Menu', 'Ordering']])
    </div>
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div id="nestable" class="dd">
                            <ol class="dd-list">
                                @each('web.menu.ordering-item', $menus, 'menu')
                            </ol>
                        </div>


                        <form id="ordering" method="post" action="{{action('Admin\MenuController@updateOrdering')}}">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
