...
@section('content')
    ...
    <div class="content-heading">
        ...
        @include('component.breadcrumb', ['items' => ['Web', 'Category', 'Ordering']])
    </div>
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div id="nestable" class="dd">
                            <ol class="dd-list">
                                @each('web.category.ordering-item', $categories, 'category')
                            </ol>
                        </div>


                        <form id="ordering" method="post" action="{{action('Admin\CategoryController@updateOrdering')}}">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
